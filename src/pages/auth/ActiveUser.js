                    ...
                    this.state.isSuccess === true ?
                        <Card className="bg-white p-3">
                            <CardBody>
                                ...
                                <h1 className="text-center">Tài khoản của bạn đã được tạo thành công</h1>
                                <h3 className="font-size-1x text-center">Cảm ơn bạn đã sử dụng phần mềm quản lý công việc online 4.0 Fwork!</h3>
