...
import { CustomImg, Attachments, Description } from "../../components/CustomTag";
import { Card, CardBody, CardHeader, CardTitle, Button, Media, Col, Row } from "reactstrap";
        ...
        return (
            <div>
                <Card>
                    ...
                    <CardBody>
                        {this.props.isLoad && this.props.openHis
                            ? null
                            : this.props.history.map((val, key) => {
                                  if (key < this.state.number) {
                                      ...
                                      if (ValidInput.isEmpty(val.diff.content) === false) {
                                          if (
                                              val.diff.content[1].length > 255 &&
                                              this.state.showfullhis !== val.id
                                          ) {
                                              return (
                                                  <div key={utils.randomString(20)}>
                                                      <Media>
                                                          ...
                                                          <Media body>
                                                              ...
                                                              <strong>
                                                                  {val.user.full_name +
                                                                      " : Đã thay đổi Description Của Wiki thành"}
                                                              </strong>
                                                              <p
                                                                  dangerouslySetInnerHTML={{
                                                                      __html: val.diff.content[1].slice(
                                                                          0,
                                                                          255,
                                                                      ),
                                                                  }}
                        ...
                        {this.props.history.length < this.state.number
                            ? null
                            : this.props.isLoadMore && (
                                  <Button onClick={this.LoadMore.bind(this)} color='primary' block>
                                      Load More{" "}
                                  </Button>
                              )}
                    </CardBody>
            ...
            <Card>
                <CardHeader className='colorheader'>
                    <CardTitle className='mb-0'>
                        ...
                        <h6 className='card-subtitle text-muted'>Created by : {username}</h6>
                    </CardTitle>
                </CardHeader>
                <CardBody>
                    {this.props.isLoad && this.props.openDes ? null : !this.state.ShowDes &&
                      this.props.openDes ? (
                        <Row>
                            <Col>
                                <Description
                    ...
                    <Row className='mt-3 row-attachments'>
                        <Col>
                            <ListFile
                                progress={this.props.progress}
                                isLoad={this.props.isLoadFile}
                                ListFile={this.props.listFile}
                                AddFile={this.props.AddFile.bind(this)}
                                DeleteFile={this.props.DeleteFile.bind(this)}
                            />
                        </Col>
                    </Row>
                    <History
                        openHis={this.props.openDes}
                        isLoad={this.props.isLoadHis}
